        ...
        try:
            ...
            if cmd.lower() == "help":
                print(
                    ...
                    "  vox <val>           - Set vox (centre) volume (0.0-1.0)\n"
                    "  sub <val>           - Set sub volume (0.0-1.0)\n"
                    "  surround <val>      - Set surround volume (0.0-1.0)\n"
                    "  sum <val>           - Set sum volume (2ch mode, 0.0-1.0)\n"
                    "  time                - Show current schedule times\n"
                    "  time start <HH:MM>  - Set start time (24h format)\n"
                    "  time stop <HH:MM>   - Set stop time (24h format)\n"
                    "  time clear          - Clear schedule (play immediately)\n"
                    "  eq                  - Show all EQ settings\n"
                    "  eq vox|sub|surround|sum - Show EQ for track\n"
